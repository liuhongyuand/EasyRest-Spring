package com.easyrest.framework.core.services.workStep.before.transaction.impl;
 ...
 */
public class TransactionPreparedWorkStepImpl extends AbstractWorkStep implements TransactionPreparedStep {

    private final PlatformTransactionManager txManager;

    @Autowired
    public TransactionPreparedWorkStepImpl(PlatformTransactionManager txManager) {
